...
exports.encode = function (object, charset, isFlag) {
  if (object === null) {
    return null;
  }
  ...
  if (typeof object === 'string') {
    ...
    buf = new Buffer(4);
    buf.writeUInt32BE(Math.floor(object.getTime() / 1000), 0);
...
//  }
  ...
  switch (type) {
    ...
    case consts.TAIR_STYPE_LONG:
      ...
      break;
    case consts.TAIR_STYPE_DATE:
      obj = new Date(vb.readUInt32BE(0) * 1000);
      break;
